        ...
        for path, subdirs, files in os.walk(arg1):
            for file in files:
                if '.JPG' in file:
                    ...
                    Image.fromarray(transformation.mask).convert('RGB').save(arg2 + filename + '-mask.JPG')
                    ...
                    Image.fromarray(transformation.canny_edges_img).convert('RGB').save(arg2 + filename + '-canny-edges.JPG')
